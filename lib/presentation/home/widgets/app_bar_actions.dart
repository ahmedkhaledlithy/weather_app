    ...
    return isSearching? IconButton(
      ...
      onPressed: () {
        if(searchController.text.isEmpty){
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("please Enter a CityName")));
        }else{
          BlocProvider.of<WeatherCubit>(context).fetchWeatherByCity(city: searchController.text.toLowerCase().trim());
        }
        },
